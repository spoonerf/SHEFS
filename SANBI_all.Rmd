...
st_join(sel_xy, bm, join = st_intersects)

# %>% 
#   st_intersection(., bm) %>% 
 

gb_sel$genus<-vapply(strsplit(gb_sel$binomial," "), `[`, 1, FUN.VALUE=character(1))

gb_sel$species<-vapply(strsplit(gb_sel$binomial," "), `[`, 2, FUN.VALUE=character(1))
